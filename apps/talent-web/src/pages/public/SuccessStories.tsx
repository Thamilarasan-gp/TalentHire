      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-white border border-slate-200/80 rounded-2xl p-8 shadow-sm space-y-6">
          ...
          <p className="text-xs sm:text-sm text-slate-600 leading-relaxed italic border-l-2 border-blue-600 pl-4">
            "Before Thamilarasan Global, our internal recruiters interviewed 60 candidates to find 2 qualified engineers. With TG, every candidate on our Top-10 shortlist had already demonstrated verified production competence. We hired all 10 in under 3 weeks."
          </p>
